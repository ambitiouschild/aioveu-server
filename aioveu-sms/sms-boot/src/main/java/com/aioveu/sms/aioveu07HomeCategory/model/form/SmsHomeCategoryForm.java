package com.aioveu.sms.aioveu07HomeCategory.model.form;
...
/**
 * @ClassName: SmsHomeCategoryForm
 * @Description TODO 首页分类配置表单对象
 * @Author 可我不敌可爱
 * @Author 雒世松
 * @Date 2026/3/4 12:10
 * @Version 1.0
...
@Getter
@Setter
@Schema(description = "首页分类配置表单对象")
public class SmsHomeCategoryForm implements Serializable {
    ...
    @NotBlank(message = "首页显示的图标URL不能为空")
    @Size(max=255, message="首页显示的图标URL长度不能超过255个字符")
    private String homeIcon;

    @Schema(description = "首页显示名称")
    @NotBlank(message = "首页显示名称不能为空")
    @Size(max=100, message="首页显示名称长度不能超过100个字符")
