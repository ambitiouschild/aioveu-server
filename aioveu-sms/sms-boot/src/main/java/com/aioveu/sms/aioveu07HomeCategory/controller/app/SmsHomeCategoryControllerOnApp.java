package com.aioveu.sms.aioveu07HomeCategory.controller.app;
...
//    @PreAuthorize("@ss.hasPerm('aioveuMallSmsHomeCategory:sms-home-category:query')")
    public Result<List<SmsHomeCategoryVO>> getSmsHomeCategoryList() {
        List<SmsHomeCategoryVO> result = smsHomeCategoryService.getSmsHomeCategoryList();
