...
public class SmsHomeAdvertController {
    ...
    @GetMapping("/page")
    @PreAuthorize("@ss.hasPerm('aioveuMallSmsHomeAdvert:sms-home-advert:query')")
    public PageResult<SmsHomeAdvertVO> getSmsHomeAdvertPage(SmsHomeAdvertQuery queryParams ) {
        IPage<SmsHomeAdvertVO> result = smsHomeAdvertService.getSmsHomeAdvertPage(queryParams);
