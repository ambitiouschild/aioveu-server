...
public interface CouponConverter {
    ...
    @Mappings({
            @Mapping(target = "platformLabel", expression = "java(com.aioveu.common.base.IBaseEnum.getLabelByValue(entity.getPlatform(), com.aioveu.sms.enums.PlatformEnum.class))"),
            @Mapping(target = "typeLabel", expression = "java(com.aioveu.common.base.IBaseEnum.getLabelByValue(entity.getType(), com.aioveu.sms.enums.CouponTypeEnum.class))"),
            @Mapping(target = "faceValueLabel", expression = "java(com.aioveu.sms.util.CouponUtils.getFaceValue(entity.getType(),entity.getFaceValue(),entity.getDiscount()))"),
            @Mapping(
                    target = "validityPeriodLabel",
                    expression = "java(com.aioveu.sms.util.CouponUtils.getValidityPeriod(entity.getValidityPeriodType(),entity.getValidityDays(),entity.getValidityBeginTime(),entity.getValidityBeginTime()))"
            ),
