...
import com.aioveu.gateway.service.impl.PermissionService;
...
public class GlobalAuthenticationFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        //1、白名单放行，比如授权服务、静态资源.....
        if (checkUrls(permissionService.getWhiteList(), requestUrl)){
        ...
        try {
            ...
            Integer gender = (Integer)additionalInformation.get(TokenConstant.GENDER);
            String nickName = (String) additionalInformation.get(TokenConstant.NICK_NAME);
            String avatar = (String) additionalInformation.get(TokenConstant.AVATAR);
            String mobile = (String) additionalInformation.get(TokenConstant.MOBILE);
            String email = (String) additionalInformation.get(TokenConstant.EMAIL);
            ...
            jsonObject.put(TokenConstant.GENDER, gender);
            jsonObject.put(TokenConstant.NICK_NAME, nickName);
            jsonObject.put(TokenConstant.AVATAR, avatar);
            jsonObject.put(TokenConstant.MOBILE, mobile);
            jsonObject.put(TokenConstant.EMAIL, email);
    ...
    private Mono<Void> invalidTokenMono(ServerWebExchange exchange) {
        return buildReturnMono(ResultMsg.builder()
                ...
                .message(ResultCode.INVALID_TOKEN.getMsg())
                .build(), exchange);
    }
