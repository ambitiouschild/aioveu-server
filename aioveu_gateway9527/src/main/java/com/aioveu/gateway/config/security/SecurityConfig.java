package com.aioveu.gateway.config.security;

import cn.hutool.core.util.ArrayUtil;
import com.aioveu.gateway.exception.RequestAccessDeniedHandler;
import com.aioveu.gateway.exception.RequestAuthenticationEntryPoint;
import com.aioveu.gateway.filter.CorsFilter;
...
public class SecurityConfig {
    ...
    SecurityWebFilterChain webFluxSecurityFilterChain(ServerHttpSecurity http) throws Exception{
        ...
        List<String> urlList = permissionService.getWhiteList();
        String[] blackUrlArray = ArrayUtil.toArray(urlList, String.class);
        ...
        http
                ...
                .authorizeExchange()
                //白名单直接放行
                .pathMatchers(blackUrlArray).permitAll()
                //其他的请求必须鉴权，使用鉴权管理器
