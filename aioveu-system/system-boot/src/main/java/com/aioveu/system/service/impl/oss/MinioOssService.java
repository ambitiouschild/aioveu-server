package com.aioveu.system.service.impl.oss;
...
public class MinioOssService implements OssService {
     ...
     *
     * @param filePath 文件路径
     *                 https://oss.aioveu.tech/default/20221120/test.jpg
     * @return
     */
    @Override
    public boolean deleteFile(String filePath) {
        ...
        try {
            ...
            if (StrUtil.isNotBlank(customDomain)) {
                // https://oss.aioveu.tech/default/20221120/test.jpg → 20221120/test.jpg
