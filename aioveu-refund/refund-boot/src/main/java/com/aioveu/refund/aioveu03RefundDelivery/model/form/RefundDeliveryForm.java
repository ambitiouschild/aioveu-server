...
/**
 * @ClassName: RefundDeliveryForm
 * @Description TODO 退款物流信息（用于退货）表单对象
 * @Author 可我不敌可爱
 * @Author 雒世松
 * @Date 2026/1/31 17:58
 * @Version 1.0
 **/

@Getter
@Setter
@Schema(description = "退款物流信息（用于退货）表单对象")
public class RefundDeliveryForm implements Serializable {
