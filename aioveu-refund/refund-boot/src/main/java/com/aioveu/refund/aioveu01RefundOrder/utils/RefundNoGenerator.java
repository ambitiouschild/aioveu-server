package com.aioveu.refund.aioveu01RefundOrder.utils;
...
/**
 * @ClassName: RefundNoGenerator
 * @Description TODO 退款单号生成器
 * @Author 可我不敌可爱
 * @Author 雒世松
 * @Date 2026/2/1 15:01
 * @Version 1.0
...
public class RefundNoGenerator {
     ...
     */
    public static String generateRefundNo(Long memberId) {
     ...
     */
    public static String generateRefundNoRandom(Long memberId) {
        // 1. 时间戳部分（14位）
     ...
     */
    public static String generateSnowflakeStyleRefundNo(Long memberId, Integer workerId) {
        // 1. 时间戳（10位，毫秒级）
     ...
     */
    public static String generateUUIDRefundNo(Long memberId) {
        // 1. 日期部分（8位）
     ...
     */
    public static String generateReversibleRefundNo(Long memberId) {
        // 1. 时间戳（13位，毫秒级）
        long timestamp = System.currentTimeMillis();
     ...
     */
    public String generateDistributedRefundNo(Long memberId) {
        // 1. 日期部分
