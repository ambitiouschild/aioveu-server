package com.aioveu.oms.aioveu06OrderSetting.model.form;
...
/**
 * @ClassName: OmsOrderSettingForm
 * @Description TODO  订单配置信息表单对象
 * @Author 可我不敌可爱
 * @Author 雒世松
 * @Date 2026/1/10 17:12
 * @Version 1.0
 **/

@Getter
@Setter
@Schema(description = "订单配置信息表单对象")
public class OmsOrderSettingForm implements Serializable {
