...
public interface OrderConverter {
    ...
    @Mappings({
            @Mapping(
                    ...
                    expression = "java(com.aioveu.common.base.IBaseEnum.getLabelByValue(bo.getPaymentMethod(), com.aioveu.oms.enums.PaymentMethodEnum.class))"
            ),
            @Mapping(
                    target = "sourceLabel",
                    expression = "java(com.aioveu.common.base.IBaseEnum.getLabelByValue(bo.getSource(), com.aioveu.oms.enums.OrderSourceEnum.class))"
            ),
            @Mapping(
                    target = "statusLabel",
                    expression = "java(com.aioveu.common.base.IBaseEnum.getLabelByValue(bo.getStatus(), com.aioveu.oms.enums.OrderStatusEnum.class))"
            ),
            @Mapping(
                    target = "orderItems",
                    source = "orderItems"
