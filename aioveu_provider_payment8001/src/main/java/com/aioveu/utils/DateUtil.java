...
public class DateUtil {
	 ...
	 * @return String
	 * */
	public static String getDayByDateHHMM(Date date){
		return new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(date);
	}


	public static Date getDayDateByDateHHMM(String  date) throws ParseException {
	 ...
	 * @return String
	 * */
	public static Date getDateAdd(Date times,Integer addTime){
		Calendar cal=Calendar.getInstance();
		cal.setTime(times);
	...
	public static List<String> splitDateList(String startDate, String endDate) {
		...
		try {
			...
			while (calendar.getTime().before(getDayByString(endDate)) || calendar.getTime().equals(getDayByString(endDate))) {
				listDate.add(getDayByDate(calendar.getTime()));
	 ...
	 * 判断两个时间谁大
	 * @param data  大的一方
	 * @param endDateStr  小的一方
	 * @return 大的一方赢 则为true  小的为false
	 */
	public static  boolean getDateDx(String data, String endDateStr){
		// 比较 年 月 日
		...
		try {
			...
			Date endDate = sdf.parse(endDateStr); //将字符串转换为 date 类型  Debug：Sun Nov 11 00:00:00 CST 2018
	...
	public static void main(String[] args) {
		String startTime ="2022-01-04 14:36:59";
		String endTime ="2022-01-05 11:32:45";
		long[] distanceTimes = getDistanceTimes(startTime, endTime);

		System.out.print(distanceTimes);
