package com.aioveu.qrcode.util;

import com.google.zxing.qrcode.encoder.ByteMatrix;
import com.aioveu.qrcode.BitMatrixEx;
import com.aioveu.qrcode.QrCodeOptions;
...
public class ImageUtil {
    ...
    public static BufferedImage getImageByPath(String path) throws IOException {
        ...
        if (path.startsWith("http")) { // 从网络获取logo
            return ImageIO.read(RestTemplateUtils.downFile(path, new RestTemplate()));
