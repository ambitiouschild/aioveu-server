package com.aioveu.tenant.aioveu12WebSocket.service.impl;

import com.aioveu.tenant.aioveu12WebSocket.model.vo.DictChangeEvent;
...
import com.aioveu.tenant.aioveu12WebSocket.service.WebSocketService;
import com.aioveu.tenant.aioveu12WebSocket.session.UserSessionRegistry;
 ...
 * @Description TODO  WebSocket 服务实现类
 *                      * 核心功能：
 *                      * - 用户在线状态管理（支持多设备登录）
 *                      * - 消息推送（广播、点对点）
 *                      * - 字典变更通知
