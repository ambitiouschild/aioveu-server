...
-- ----------------------------
-- Table structure for aioveu_registry_tenant
-- 租户注册小程序基本信息表 (aioveu_registry_tenant) - 存储租户基本信息
-- ----------------------------
...
-- ----------------------------
-- Table structure for aioveu_registry_app_account 小程序账号表 - 存储小程序账号信息
-- ----------------------------
