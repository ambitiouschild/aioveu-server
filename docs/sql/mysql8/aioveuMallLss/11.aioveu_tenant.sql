...
# aioveu_tenant 数据库(MySQL 5.7 ~ MySQL 8.x) - 多租户版本
# Copyright (c) 2021-present, aioveu.com
# 
...
-- 1. 创建数据库
-- ----------------------------
CREATE DATABASE IF NOT EXISTS aioveu_tenant CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_unicode_ci;
...
INSERT INTO `sys_dept` VALUES (1, 0, '可我不敌可爱', 'AIOVEU', 0, '0', 1, 1, 1, NULL, 1, now(), 0);
