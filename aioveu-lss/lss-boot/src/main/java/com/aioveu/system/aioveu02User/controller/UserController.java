package com.aioveu.system.aioveu02User.controller;
...
public class UserController {
    ...
    @GetMapping("/{username}/UserAuthCredentials")
    @Log(value = "根据用户名获取认证信息", module = LogModuleEnum.USER)
    public Result<UserAuthCredentials> getAuthCredentialsByUsername(
