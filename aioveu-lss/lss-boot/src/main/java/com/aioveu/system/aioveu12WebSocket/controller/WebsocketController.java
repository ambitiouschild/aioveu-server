package com.aioveu.system.aioveu12WebSocket.controller;

import com.aioveu.system.aioveu12WebSocket.model.vo.ChatMessage;
 ...
 * @Description TODO  WebSocket 测试用例控制层  包含点对点/广播发送消息
 * @Author 可我不敌可爱
 * @Author 雒世松
 * @Date 2025/12/31 17:46
 * @Version 1.0
 **/

@Tag(name = "12.广播发送消息接口")
@RestController
