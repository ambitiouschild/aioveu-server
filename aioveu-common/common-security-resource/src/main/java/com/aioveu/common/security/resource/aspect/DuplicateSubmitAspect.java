package com.aioveu.common.security.resource.aspect;
 ...
 * @Description: TODO 防重复提交切面
                     * 这个 DuplicateSubmitAspect不能放在 common-web
                     * ✅ 必须放在 common-security-resource
                     * ✅ 它的核心依赖不是 Web，是 Security
 * ❌ 不能留在 common-web，哪怕它只用了 SecurityUtils
 * @Author: 雒世松
 * @Date: 2025/6/5 16:21
 * @param
 * @return:
