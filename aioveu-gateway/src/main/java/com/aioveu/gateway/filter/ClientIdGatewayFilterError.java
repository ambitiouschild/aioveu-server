...
//@Component
@Slf4j
public class ClientIdGatewayFilterError implements GlobalFilter, Ordered {
    ...
    public ClientIdGatewayFilterError(@Lazy @Qualifier("gatewayJwtDecoder") ReactiveJwtDecoder jwtDecoder,
